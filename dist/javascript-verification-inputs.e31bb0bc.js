...
function handlePaste(e) {
  var paste = e.clipboardData.getData('text'); // loop over each input, and populate with the index of that string
  ...
  var checkStatus = checkSubmission(inputs);
...
function submitForm() {//don't form.submit() as will lose the ui message instead submit via ajax
}
...
function checkSubmission(fields) {
  ...
  var fieldValues = _toConsumableArray(fields).map(function (i) {
    return i.value || null;
...
inputs[0].addEventListener('paste', handlePaste); // select text when click into an input field - honestly 

form.addEventListener('focusin', handleFocus);
form.addEventListener('input', handleInput);
form.addEventListener('change', handleChange); // 1. select the text when the next input is focued
// 2. Auto submit the form if all fields are filled after a paste
// 3. support for backspacing from 1 input to another
},{}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/javascript-verification-inputs.e31bb0bc.js.map